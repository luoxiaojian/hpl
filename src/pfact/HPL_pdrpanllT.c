...
void HPL_pdrpanllT(HPL_T_panel* PANEL, const int M, const int N,
  ...
  do {
     ...
     */
    HPL_dtrsm(HplColumnMajor, HplRight, HplUpper, HplNoTrans, HplUnit, jb, jj,
              HPL_rone, L1ptr, n0, Mptr(L1ptr, jj, 0, n0), n0);
#ifdef HPL_CALL_VSIPL
    /*
     * Admit the blocks
     */
