...
void HPL_pdrpancrN(HPL_T_panel* PANEL, const int M, const int N,
 ...
 */
    ...
    if (n > 0) {
      ...
      (void)vsip_mdestroy_d(Lv0);
#else
      HPL_dgemm(HplColumnMajor, HplNoTrans, HplNoTrans, jb, n, jj, -HPL_rone,
                Mptr(L1ptr, jj, 0, n0), n0, Mptr(L1ptr, 0, jj + jb, n0), n0,
                HPL_rone, Mptr(L1ptr, jj, jj + jb, n0), n0);
#endif
