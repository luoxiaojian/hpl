...
void HPL_pdrpanrlT(HPL_T_panel* PANEL, const int M, const int N,
...
#else
    HPL_dgemm(HplColumnMajor, HplNoTrans, HplTrans, m, n, jb, -HPL_rone,
              Mptr(Aptr, ii, jj, lda), lda, Mptr(L1ptr, jj + jb, jj, n0), n0,
              HPL_rone, Mptr(Aptr, ii, jj + jb, lda), lda);
#endif
    /*
