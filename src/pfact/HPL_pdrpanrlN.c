...
void HPL_pdrpanrlN(HPL_T_panel* PANEL, const int M, const int N,
  ...
  do {
    ...
    HPL_dtrsm(HplColumnMajor, HplLeft, HplLower, HplNoTrans, HplUnit, jb, n,
...
#else
    HPL_dgemm(HplColumnMajor, HplNoTrans, HplNoTrans, m, n, jb, -HPL_rone,
              Mptr(Aptr, ii, jj, lda), lda, Mptr(L1ptr, jj, jj + jb, n0), n0,
