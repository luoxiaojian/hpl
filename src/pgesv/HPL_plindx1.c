...
void HPL_plindx1(HPL_T_panel* PANEL, const int K, const int* IPID, int* IPA,
                 int* LINDXA, int* LINDXAU, int* IPLEN, int* IPMAP,
                 int* IPMAPM1, int* PERMU, int* IWORK) {
  /*
   * Purpose
   * =======
   *
   ...
   */
  int* iwork;
  int dst, dstrow, fndd, i, ia, icurrow, il, ip, ipU, iroff, j, jb, myrow, nb,
      nprow, src, srcrow;
  /*
