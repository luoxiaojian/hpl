...
void HPL_pdupdateTT(HPL_T_panel* PBCST, int* IFLAG, HPL_T_panel* PANEL,
                    const int NN) {
  /*
   * Purpose
   * =======
 ...
 */
      ...
      HPL_dlaswp00N(jb, nn, Aptr, lda, ipiv);
#endif
      HPL_dtrsm(HplColumnMajor, HplLeft, HplUpper, HplTrans, HplUnit, jb, nn,
  ...
  } else /* nprow > 1 ... */
  {
    ...
    while (test == HPL_KEEP_TESTING) {
      ...
      HPL_dtrsm(HplColumnMajor, HplRight, HplUpper, HplNoTrans, HplUnit, nn, jb,
