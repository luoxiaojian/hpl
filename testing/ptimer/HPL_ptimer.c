...
static double HPL_ptimer_cpusec[HPL_NPTIMER], HPL_ptimer_cpustart[HPL_NPTIMER],
    HPL_ptimer_wallsec[HPL_NPTIMER], HPL_ptimer_wallstart[HPL_NPTIMER];
/*
 * ---------------------------------------------------------------------
...
void HPL_ptimer_combine(MPI_Comm COMM, const HPL_T_PTIME_OP OPE,
                        const HPL_T_PTIME TMTYPE, const int N, const int IBEG,
                        double *TIMES) {
  /*
   * Purpose
   * =======
